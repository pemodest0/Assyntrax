...
def _load_finance() -> Dict:
    cfg = _load_config(Path("data/configs/data_pipeline_finance.json"))
...
def _load_logistics() -> Dict:
    cfg = _load_config(Path("data/configs/data_pipeline_logistics.json"))
...
def _load_health() -> Dict:
    cfg = _load_config(Path("data/configs/data_pipeline_health.json"))
