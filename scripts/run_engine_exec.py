...
from temporal_engine.diagnostics.predictability import compute_acf, hurst_exponent_rs, lyapunov_proxy
from temporal_engine.temporal_engine import TemporalConfig, YearResult, build_temporal_report, compare_models
