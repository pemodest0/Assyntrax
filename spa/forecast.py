...
def forecast_series(
    ...
    if step is None:
        return (
            pd.DataFrame(columns=["time", "value_previsto"]),
            "Nao foi possivel prever porque o passo de tempo e irregular.",
        )
    ...
    obs = "Previsao simples baseada nos pontos mais recentes."
    return forecast_df, obs
