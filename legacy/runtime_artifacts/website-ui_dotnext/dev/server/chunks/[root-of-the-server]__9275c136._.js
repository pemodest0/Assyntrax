...
"[project]/app/api/files/[...path]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_request, { params }) {
    try {
        ...
        const rel = path.join("/");
        const target = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$results$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resolveResultsPath"])(rel);
        const data = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].readFile(target);
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](data, {
            status: 200,
            headers: {
                "content-type": (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2f$results$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["contentTypeFor"])(target)
            }
        });
    } catch  {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9275c136._.js.map