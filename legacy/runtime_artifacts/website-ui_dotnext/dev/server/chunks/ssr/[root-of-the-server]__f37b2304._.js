...
function SiteHeader() {
    const { isEn, base, enPath } = resolveLang((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["usePathname"])());
    const labels = isEn ? {
        product: "Product",
        methods: "Methods",
        about: "About",
