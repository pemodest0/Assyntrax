  ...
  return (
    <div className="space-y-10">
      <div className="space-y-3">
        <h1 className="text-4xl font-semibold tracking-tight">Por que a Assyntrax existe</h1>
        <p className="text-zinc-300 max-w-3xl">
          Problema: mercados mudam de regime e modelos tradicionais continuam prevendo como se
          nada tivesse mudado. Solução: diagnóstico de estado antes de previsão.
        </p>
      </div>

      <section className="rounded-3xl border border-zinc-800 bg-zinc-950/60 p-8">
        <div className="text-sm uppercase tracking-[0.2em] text-zinc-400">O que fazemos diferente</div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="rounded-3xl border border-zinc-800 bg-zinc-950/60 p-8">
          <div className="text-sm uppercase tracking-[0.2em] text-zinc-400">História</div>
        ...
        <div className="rounded-3xl border border-zinc-800 bg-zinc-950/60 p-8">
          <div className="text-sm uppercase tracking-[0.2em] text-zinc-400">Futuro</div>
      ...
      <section className="rounded-3xl border border-zinc-800 bg-zinc-950/60 p-8">
        <div className="text-sm uppercase tracking-[0.2em] text-zinc-400">Fases do produto</div>
